...
public class BinTools {
	 ...
	 * @return Hexadecimal representation of b. Uppercase A-F, two characters per byte. Empty string on <code>null</code> input.
	 */
	 ...
	 *
	 * @param s
	 *            String containing hexadecimal digits. May be <code>null</code>. On odd length leading zero will be assumed.
